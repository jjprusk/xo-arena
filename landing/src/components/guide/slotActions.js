...
export const SLOT_ACTIONS = [
  ...
  { key: 'create_bot',  label: 'Create 1st Bot', icon: '🤖', href: `${XO}/profile?action=create-bot`,   section: 'XO Arena',  crossSite: true },
  { key: 'profile_bots', label: 'My Bots',        icon: '🤖', href: `${XO}/profile?section=bots`,        section: 'XO Arena',  crossSite: true },
