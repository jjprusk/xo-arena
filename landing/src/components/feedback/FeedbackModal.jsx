...
/**
 * Feedback submission modal — posts to `${apiBase}/feedback`. Ported from
 * the retired frontend/ app (Phase 3.0). Screenshot auto-captured on
 * desktop (via FeedbackButton), file-picker fallback on mobile.
 */
