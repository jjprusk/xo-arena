    ...
    <form onSubmit={handleSubmit} className="space-y-4" noValidate>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <Field label="Registration Opens At" hint="Optional">
          <input type="datetime-local" value={form.registrationOpenAt} onChange={e => set('registrationOpenAt', e.target.value)}
            className={INPUT_CLASS} style={FIELD_STYLE} />
        </Field>
        <Field label="Registration Closes At" hint="Optional">
          <input type="datetime-local" value={form.registrationCloseAt} onChange={e => set('registrationCloseAt', e.target.value)}
            className={INPUT_CLASS} style={FIELD_STYLE} />
