...
describe('aiMetrics', () => {
  ...
  it('getSummary groups by implementation+difficulty', () => {
    recordMove({ implementation: 'minimax', difficulty: 'hard', durationMs: 10, cellIndex: 0 })
    recordMove({ implementation: 'minimax', difficulty: 'hard', durationMs: 20, cellIndex: 4 })
    recordMove({ implementation: 'minimax', difficulty: 'easy', durationMs: 2, cellIndex: 1 })
  ...
  it('getHistogram buckets by durationMs', () => {
    recordMove({ implementation: 'minimax', difficulty: 'hard', durationMs: 5, cellIndex: 0 })  // 0-10ms
    recordMove({ implementation: 'minimax', difficulty: 'hard', durationMs: 30, cellIndex: 0 }) // 10-50ms
    recordMove({ implementation: 'minimax', difficulty: 'hard', durationMs: 600, cellIndex: 0 }) // 500ms+
  ...
  it('getHistogram filters by implementation and difficulty', () => {
    ...
    recordMove({ implementation: 'minimax', difficulty: 'easy', durationMs: 1, cellIndex: 0 })

    const hist = getHistogram('minimax', 'hard')
  ...
  it('getHeatmap filters by implementation and difficulty', () => {
    ...
    const heatmap = getHeatmap('minimax', 'hard')
