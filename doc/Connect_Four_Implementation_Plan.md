...
| A3a — Training data + UX rework (in-process) | in progress | 5/15 | Presets (Quick/Standard/Deep) per (game, algorithm) + ETA computed up front and persisted onto the session. Earlier: schema audit, channel rename, tournament ELO + series-winner attribution. |
