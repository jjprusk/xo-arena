...
const MENU = [
  ...
  I('PlayVsBot mobile (Fast 3G) — local',              () => perf('perf-playvsbot-mobile.js'),                       'http://localhost:5174'),
  I('PlayVsBot mobile (Fast 3G) — staging',            () => perf('perf-playvsbot-mobile.js', ['--target=staging']), 'no auth needed'),
  I('PlayVsBot mobile (Fast 3G) — prod',               () => perf('perf-playvsbot-mobile.js', ['--target=prod']),    'no auth needed'),
  D(),
  S('Long-running'),
