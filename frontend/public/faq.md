...
<img src="/screenshots/guide-button.png" alt="Guide button in the header" style="max-width:480px;border-radius:8px;margin:12px 0;border:1px solid #e5e7eb;" />
...
<img src="/screenshots/guide-overview.png" alt="Guide step map" style="max-width:600px;border-radius:8px;margin:12px 0;border:1px solid #e5e7eb;" />
