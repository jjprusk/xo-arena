...
const STEPS = [
  ...
  { index: 2, title: 'Play your first game',     cta: 'Play now',           href: '/play'            },
  ...
  { index: 5, title: 'Train your bot',           cta: 'Start training',     href: '/gym'             },
...
const RING_R   = 13
const RING_C   = 18   // cx/cy
const RING_CIRC = 2 * Math.PI * RING_R   // ≈ 81.7
...
function DismissConfirm({ onCancel, onConfirm }) {
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-label="Dismiss journey confirmation"
      style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          <button
            onClick={onCancel}
            style={{
              flex: 1, padding: '0.5rem', borderRadius: '0.4375rem',
              fontSize: '0.8125rem', fontWeight: 700, cursor: 'pointer',
              background: 'rgba(255,255,255,0.08)', color: 'var(--guide-text, #E8EDF6)',
              border: '1.5px solid rgba(255,255,255,0.1)',
            }}
          >
            Keep going
          ...
          <button
            ...
            style={{
              flex: 1, padding: '0.5rem', borderRadius: '0.4375rem',
              fontSize: '0.8125rem', fontWeight: 700, cursor: 'pointer',
              background: 'var(--color-red-500)', color: 'white', border: 'none',
            }}
          >
            Yes, dismiss
          </button>
...
export default function JourneyCard() {
  ...
  if (isComplete) {
    return (
      <div style={{
        background: 'rgba(36,181,135,0.07)',
        border: '1.5px solid rgba(36,181,135,0.4)',
        borderRadius: '0.75rem',
        padding: '1rem',
        textAlign: 'center',
        position: 'relative',
      }}>
        <div className="journey-complete-orb" style={{
          width: 48, height: 48, borderRadius: '50%',
          background: 'radial-gradient(circle at 35% 35%, #6EE7B7, var(--color-teal-600))',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontSize: '1.5rem', margin: '0 auto 0.75rem',
          boxShadow: '0 0 16px rgba(36,181,135,0.4)',
        }}>🏆</div>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '0.9375rem', fontWeight: 700, color: 'var(--guide-text, #E8EDF6)', marginBottom: '0.25rem' }}>
          Onboarding Complete!
        </h3>
        ...
        <button
          ...
          style={{
            width: '100%', padding: '0.4375rem', borderRadius: '0.4375rem',
  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '0.75rem', display: 'flex', alignItems: 'flex-start', gap: '0.5rem' }}>
        ...
        <div style={{ position: 'relative', width: 36, height: 36, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{
            ...
            background: 'radial-gradient(circle at 35% 35%, #F0C56A, var(--color-amber-600))',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: '0.8125rem',
          }}>🤖</div>
        </div>
      ...
      <div style={{ background: 'rgba(212,137,30,0.15)', borderRadius: 999, height: 3, overflow: 'hidden', margin: '0 0.75rem' }}>
        <div style={{
          height: '100%', background: 'var(--color-amber-500)',
          borderRadius: 999,
        ...
        <div style={{ borderTop: '1px solid rgba(212,137,30,0.12)', padding: '0.5rem 0.75rem 0.75rem' }}>
          {STEPS.map(step => {
            ...
            return (
              <div key={step.index} style={{
                ...
                padding: '0.375rem 0',
                borderBottom: step.index < TOTAL ? '1px solid rgba(255,255,255,0.04)' : 'none',
              }}>
                {/* Step marker */}
                <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '0.5rem' }}>
            <button
              ...
              style={{
                fontSize: '0.6875rem', color: 'var(--guide-text-muted, #5A6478)',
                padding: '0.2rem 0.375rem', borderRadius: '0.25rem',
